...
import me.principality.session.receiver.{BackHandler, Receiver}
...
class FrontHandler extends ChannelInboundHandlerAdapter {
  ...
  private val remoteHost: String = conf.getString("front.host")
  private val remotePort: Int = conf.getInt("front.port")
